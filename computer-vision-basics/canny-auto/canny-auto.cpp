...
int main(int argc, char** argv) {
    ...
    parser.about("Apply the Canny edge detector with auto threshold");

    if (parser.has("help")) {
        parser.printMessage();
        printf("Example:\n");
        printf("canny-auto coins.jpg\n");
        return 0;
    }
    ...
    // Auto threshold
    cvutils::CannyAuto(blurred, edges, 0.6);
    imshow("Auto Edge Map", edges);
    waitKey();
